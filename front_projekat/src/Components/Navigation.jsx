...
const menus = {
  administrator: [
    ...
    {name:"Pretrazi sastojke iz poznatih kompanija",path:"/javni-api"}
  ],
  korisnik: [
...
export default function Navigation() {
  ...
  const role = sessionStorage.getItem("role") || "gost";
  ...
  if (role === "gost") {
    const leftLinks = [menus.gost[0]]; 
    const rightLinks = menus.gost.slice(1); 
